...
___bank_actor_65_update = 255
.globl ___bank_actor_65_update
...
3$:
        ...
        ; Switch Variable
        VM_SWITCH               VAR_S7A5_DIRECTION, 4, 0
        .dw 1, 4$
        .dw 2, 5$
        .dw 3, 6$
        .dw 4, 7$
...
8$:
        ...
        VM_RAND                 VAR_S7A5_DIRECTION, 1, 4

        ; If Variable .LTE Value
        VM_IF_CONST             .LTE, VAR_S7A7_HEALTH_4, 0, 9$, 0
        VM_JUMP                 10$
9$:
        ; Variables .SUB Value
        VM_RPN
