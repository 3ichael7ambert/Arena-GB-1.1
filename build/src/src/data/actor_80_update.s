...
___bank_actor_80_update = 255
.globl ___bank_actor_80_update
...
3$:
        ...
        ; Switch Variable
        VM_SWITCH               VAR_S2A7_DIRECTION, 4, 0
        .dw 1, 4$
        .dw 2, 5$
        .dw 3, 6$
        .dw 4, 7$
...
8$:
        ...
        VM_RAND                 VAR_S2A7_DIRECTION, 1, 4

        ; If Variable .LTE Value
        VM_IF_CONST             .LTE, VAR_S2A2_HEALTH_6, 0, 9$, 0
        VM_JUMP                 10$
9$:
        ; Variables .SUB Value
        VM_RPN
