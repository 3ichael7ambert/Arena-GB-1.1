...
.globl b_wait_frames, _wait_frames, _fade_frames_per_step, _camera_settings, ___bank_scene_13, _scene_13, ___bank_scene_10, _scene_10
...
2$:
        ...
        VM_RPN
            ...
            .R_STOP
        ; If Truthy
        VM_IF_CONST             .NE, .LOCAL_TMP2_IF_VALUE, 0, 4$, 0
        ; Load Scene
...
3$:
        ...
        VM_RPN
            ...
            .R_STOP
        ; If Falsy
        VM_IF_CONST             .EQ, .LOCAL_TMP4_IF_VALUE, 0, 6$, 0
        VM_JUMP                 7$
6$:
        ; Variable Decrement By 1
        VM_RPN
            .R_REF      VAR_S11A11_COOLCOUNT
            .R_INT8     1
            .R_OPERATOR .SUB
            .R_REF_SET  VAR_S11A11_COOLCOUNT
            .R_STOP
...
7$:
        ...
        VM_RPN
            ...
            .R_STOP
        ; If Truthy
        VM_IF_CONST             .NE, .LOCAL_TMP5_IF_VALUE, 0, 8$, 0
        VM_JUMP                 9$
8$:
        ; Variable Set To
