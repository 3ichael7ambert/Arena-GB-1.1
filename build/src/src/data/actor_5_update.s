...
.globl b_wait_frames, _wait_frames, _fade_frames_per_step, _camera_settings, ___bank_scene_0, _scene_0
...
4$:
        ...
        VM_RPN
            .R_REF      VAR_S3A3_COOLCOUNT
            .R_INT8     1
            .R_OPERATOR .SUB
            .R_REF_SET  VAR_S3A3_COOLCOUNT
            .R_STOP
...
6$:
        ...
        ; Variable Set To
        VM_SET_CONST            VAR_S3A3_COOLCOUNT, 1
